...
class Notes(models.Model):
    ...
    uploader = models.ForeignKey(
        User, on_delete=models.DO_NOTHING, related_name="notes_uploader"
    )
    ...
    notes_course = models.CharField(
        null=True, blank=True, max_length=50, choices=NOTES_COURSE_CHOICES
    )
...
def note_file_path(instance: "NotesFiles", filename: str) -> str:
    ...
    return os.path.join(
        "NoteFiles", instance.note.level, instance.note.subject, filename
    )

...
describe('slideshowApi', () => {
  ...
  describe('listSlideshows', () => {
    it('should fetch paginated slideshows', async () => {
      ...
      mock.onGet('http://localhost:8000/api/slideshows/').reply(200, mockResponse);
    ...
    it('should apply filter parameters', async () => {
      ...
      mock.onGet('http://localhost:8000/api/slideshows/', { params: { visibility: 'public', subject: 'math' } }).reply(200, mockResponse);

      const result = await listSlideshows({ visibility: 'public', subject: 'math' });
      expect(result.results).toHaveLength(1);
    });

    it('should handle errors', async () => {
      mock.onGet('http://localhost:8000/api/slideshows/').reply(500, { detail: 'Server error' });
  ...
  describe('listMySlideshows', () => {
    it('should fetch only user slideshows', async () => {
      ...
      mock.onGet('http://localhost:8000/api/slideshows/', { params: { mine: true } }).reply(200, mockResponse);
  ...
  describe('getSlideshowDetail', () => {
    it('should fetch slideshow with all slides', async () => {
      const mockSlideshow: SlideshowDetail = {
        ...
        slide_count: 2,
        slides: [
          { id: 1, order: 0, rendered_content: '<h1>Slide 1</h1>', content: '# Slide 1', notes: '' },
          { id: 2, order: 1, rendered_content: '<h1>Slide 2</h1>', content: '# Slide 2', notes: '' },
        ],
        remaining_slide_ids: [],
      ...
      mock.onGet('http://localhost:8000/api/slideshows/1/').reply(200, mockSlideshow);
    ...
    it('should support progressive loading', async () => {
      ...
      mock.onGet('http://localhost:8000/api/slideshows/1/', { params: { initial: 2 } }).reply(200, mockSlideshow);
  ...
  describe('createSlideshow', () => {
    it('should create a new slideshow with slides', async () => {
      ...
      mock.onPost('http://localhost:8000/api/slideshows/').reply(200, mockResponse);
  ...
  describe('updateSlideshow', () => {
    it('should update slideshow successfully', async () => {
      ...
      const mockResponse: SlideshowDetail = {
        ...
        slide_count: 3,
        slides: [
          { id: 1, order: 0, rendered_content: '<h1>Updated Slide 1</h1>', content: '# Updated Slide 1', notes: '' },
          { id: 2, order: 1, rendered_content: '<h1>Updated Slide 2</h1>', content: '# Updated Slide 2', notes: '' },
          { id: 3, order: 2, rendered_content: '<h1>New Slide 3</h1>', content: '# New Slide 3', notes: '' },
        ],
        remaining_slide_ids: [],
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
      ...
      mock.onPatch('http://localhost:8000/api/slideshows/1/').reply(200, mockResponse);
  ...
  describe('deleteSlideshow', () => {
    ...
    it('should handle errors', async () => {
      mock.onDelete('http://localhost:8000/api/slideshows/1/').reply(404, { detail: 'Not found' });
  ...
  describe('previewMarkdown', () => {
    it('should render markdown to HTML', async () => {
      ...
      mock.onPost('http://localhost:8000/api/slideshows/preview/').reply(200, { rendered_content: rendered });
    ...
    it('should support abort signal', async () => {
      ...
      mock.onPost('http://localhost:8000/api/slideshows/preview/').reply(200, { rendered_content: '<h1>Test</h1>' });

      controller.abort();

      await expect(previewMarkdown(markdown, controller.signal)).rejects.toThrow();
    });
  });
  ...
  describe('Slide operations', () => {
    it('should get individual slide', async () => {
      ...
      mock.onGet('http://localhost:8000/api/slideshows/1/slides/1/').reply(200, mockSlide);
    ...
    it('should create a new slide', async () => {
      ...
      mock.onPost('http://localhost:8000/api/slideshows/1/slides/').reply(200, mockResponse);
    ...
    it('should update a slide', async () => {
      ...
      mock.onPatch('http://localhost:8000/api/slideshows/1/slides/1/').reply(200, mockResponse);
    ...
    it('should delete a slide', async () => {
      mock.onDelete('http://localhost:8000/api/slideshows/1/slides/1/').reply(204);

 ...
 * Usage examples:
 * <Input id="123" />
 * <Input >Secondary Small</Input>
 * <Input type="danger" disabled>Delete</Input>
 */
...
type Props = {
    ...
    required?: boolean,
    placeholder?: string,
    type?: 'password' | 'text' | 'email' | 'number' | 'tel' | 'url' | 'submit',
    value?: string,
...
const Input = (props:Props) =>{
    ...
    return (
        <div className="relative pt-4">
            ...
            <input {...props.register(props.label, {
            ...
            />
            {props.error?<p className="text-sm text-red-700 text-start">{props.error}</p>:null}
